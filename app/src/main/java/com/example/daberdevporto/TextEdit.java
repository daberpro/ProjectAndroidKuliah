 ...
 * Use the {@link TextEdit#newInstance} factory method to
...
public class TextEdit extends Fragment {
    ...
    public static TextEdit newInstance(String param1, String param2) {
        TextEdit fragment = new TextEdit();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button process = (Button) view.findViewById(R.id.process_text);
